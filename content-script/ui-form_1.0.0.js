...
<style>
    ...
    #anomaly-search thead th {padding: 1px 2px; background-color:#990000; color:white; border:1px solid #383b40; text-align:right;}
...
<tbody>
    <tr>
        ...
        <td colspan="10"><a class="item color3">중골</a></td>
    </tr>
    <tr>
        <td colspan="3"><a class="item color1">가죽</a></td>
        <td colspan="7"><a class="item color2">가죽+</a></td>
        <td colspan="10"><a class="item color3">두툼가죽</a></td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="10"><a class="item color3">중용골</a></td>
    </tr>
    <tr>
        <td class="border0"></td>
        <td colspan="2"><a class="item color1">피</a></td>
        <td colspan="7"><a class="item color2">깨끗한피</a></td>
        <td colspan="10"><a class="item color3">정농혈</a></td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="10"><a class="item color3">두툼비늘</a></td>
    </tr>
    <tr>
        <td class="border0" colspan="2"></td>
        <td><a class="item color1">갑각</a></td>
        <td colspan="7"><a class="item color2">견갑각</a></td>
        <td colspan="10"><a class="item color3">중갑각</a></td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="10"><a class="item color3">중어금니</a></td>
    </tr>
    <tr>
        <td class="border0" colspan="3"></td>
        <td colspan="7"><a class="item color1">발톱</a>/<a class="color2">첨예발톱</a></td>
        <td colspan="10"><a class="item color3">억센발톱</a></td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="7"><a class="item color5">흉첨예뿔</a></td>
        <td colspan="3"><a class="item color6">흉억센뿔</a></td>
    </tr>
    <tr>
        <td class="border0" colspan="5"></td>
        <td colspan="5"><a class="item color4">흉뼈</a></td>
        <td colspan="7"><a class="item color5">흉견골</a></td>
        <td colspan="3"><a class="item color6">흉중골</a></td>
    </tr>
    <tr>
        <td class="border0" colspan="5"></td>
        <td colspan="5"><a class="item color4">흉비늘</a></td>
        <td colspan="7"><a class="item color5">흉비늘+</a></td>
        <td colspan="3"><a class="item color6">흉두툼비늘</a></td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="7"><a class="item color5">흉견갑각</a></td>
        <td colspan="2"><a class="item color6">흉중갑각</a></td>
    </tr>
    <tr>
        <td class="border0" colspan="7"></td>
        <td colspan="4"><a class="item color4">흉발톱</a></td>
        <td colspan="7"><a class="item color5">흉첨예발톱</a></td>
        <td colspan="2"><a class="item color6">흉억센발톱</a></td>
    </tr>
    
    <tr>
        <th rowspan="3"><a class="ex color4">EX7</a></th>
        <td class="border0" colspan="8"></td>
        <td colspan="6"><a class="item color4">흉이빨</a></td>
        <td colspan="6"><a class="item color5">흉이빨+</a></td>
    </tr>
    <tr>
        <td class="border0" colspan="8"></td>
        <td colspan="6"><a class="item color4">흉피</a></td>
        <td colspan="6"><a class="item color5">흉깨끗한피</a></td>
    </tr>
    <tr>
        <td class="border0" colspan="8"></td>
        <td colspan="6"><a class="item color4">흉익막</a></td>
